      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <div className="text-sm tracking-[0.3em] mb-2">UN SEMPLICE INCIDENTE</div>
            <div className="text-sm text-neutral-500">© 2025 Lucky Red. Tutti i diritti riservati.</div>
          </div>
